...
custom_imports = dict(
    ...
    imports=[
        'orenet_modules.custom_head',
        'orenet_modules.legnet',
    ])
data_root = 'data/coco/'
...
model = dict(
    ...
    roi_head=dict(
        ...
        mask_head=dict(
            ...
            in_channels=256,
            loss_edge=dict(loss_weight=0.05, type='SpatialGradientLoss'),
            loss_mask=dict(
...
train_cfg = dict(max_epochs=150, type='EpochBasedTrainLoop', val_interval=10)
